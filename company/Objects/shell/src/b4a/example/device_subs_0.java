...
device.mostCurrent._pagelabel = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");
 //BA.debugLineNum = 21;BA.debugLine="Dim PHPURL As String = \"https://192.168.8.141/Com";
device.mostCurrent._phpurl = RemoteObject.concat(RemoteObject.createImmutable("https://192.168.8.141/Company/fetch.php?action=get_device&id="),device.mostCurrent._branch._branch_selected /*RemoteObject*/ ,RemoteObject.createImmutable("&page="),device._pageno,RemoteObject.createImmutable("limit="),device._limit);
