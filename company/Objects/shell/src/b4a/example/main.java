...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"barGraph",Debug.moduleToString(b4a.example.bargraph.class),"Branch",Debug.moduleToString(b4a.example.branch.class),"Button1",main.mostCurrent._button1,"company",main._company,"Device",Debug.moduleToString(b4a.example.device.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Label1",main.mostCurrent._label1,"navigate",main.mostCurrent._navigate,"Panel1",main.mostCurrent._panel1,"Panel2",main.mostCurrent._panel2,"PHPURL",main.mostCurrent._phpurl,"primaryFontSize",main._primaryfontsize,"ScrollView1",main.mostCurrent._scrollview1,"secondaryFontSize",main._secondaryfontsize,"Starter",Debug.moduleToString(b4a.example.starter.class),"TableDetails",main.mostCurrent._tabledetails,"titleFontSize",main._titlefontsize,"xui",main._xui};
}
}