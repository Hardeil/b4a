...
try {
		Debug.PushSubsStack("DrawWrappedTextRotated (bargraph) ","bargraph",4,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("FormatNumberWithLabel (bargraph) ","bargraph",4,__ref.getField(false, "ba"),__ref,134);
...
try {
		Debug.PushSubsStack("FormatNumberWithSuffix (bargraph) ","bargraph",4,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("Initialize (bargraph) ","bargraph",4,__ref.getField(false, "ba"),__ref,6);
...
_legendpanel.runMethod(true,"setHeight",bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30))));
 BA.debugLineNum = 36;BA.debugLine="panel.AddView(legendPanel, (panel.Width/2)- 100di";
Debug.ShouldStop(8);
_panel.runVoidMethod ("AddView",(Object)((_legendpanel.getObject())),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_panel.runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0)),bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))}, "-",1, 0))),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_activitypanel" /*RemoteObject*/ ).runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0)),bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 120)))}, "+",1, 0))),(Object)(bargraph.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))));
 BA.debugLineNum = 38;BA.debugLine="Dim color() As Int = Array As Int(Colors.RGB(255,";
Debug.ShouldStop(32);
_color = RemoteObject.createNewArray("int",new int[] {3},new Object[] {bargraph.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0))),bargraph.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 200)),(Object)(BA.numberCast(int.class, 20)),(Object)(BA.numberCast(int.class, 20))),bargraph.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 100)),(Object)(BA.numberCast(int.class, 10)),(Object)(BA.numberCast(int.class, 10)))});Debug.locals.put("color", _color);Debug.locals.put("color", _color);
 BA.debugLineNum = 40;BA.debugLine="Dim legendWidth As Int = legendPanel.Width / lege";
Debug.ShouldStop(128);
...
{
final int step27 = 1;
final int limit27 = RemoteObject.solve(new RemoteObject[] {_legend.getField(true,"length"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
_i = 0 ;
for (;(step27 > 0 && _i <= limit27) || (step27 < 0 && _i >= limit27) ;_i = ((int)(0 + _i + step27))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 43;BA.debugLine="Dim colorLabel As Label";
Debug.ShouldStop(1024);
_colorlabel = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("colorLabel", _colorlabel);
 BA.debugLineNum = 44;BA.debugLine="colorLabel.Initialize(\"\")";
Debug.ShouldStop(2048);
_colorlabel.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 45;BA.debugLine="colorLabel.Color = color(i)";
Debug.ShouldStop(4096);
_colorlabel.runVoidMethod ("setColor",_color.getArrayElement(true,BA.numberCast(int.class, _i)));
 BA.debugLineNum = 46;BA.debugLine="legendPanel.AddView(colorLabel, (legendWidth * i";
Debug.ShouldStop(8192);
