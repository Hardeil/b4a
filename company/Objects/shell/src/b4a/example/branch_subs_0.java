...
try {
		Debug.PushSubsStack("Activity_Create (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,352);
...
try {
		Debug.PushSubsStack("Activity_Pause (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,479);
...
try {
		Debug.PushSubsStack("Activity_Resume (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,475);
...
try {
		Debug.PushSubsStack("closeButton_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,463);
...
try {
		Debug.PushSubsStack("edit_button_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,432);
...
Debug.ShouldStop(2097152);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","01310726",RemoteObject.concat(RemoteObject.createImmutable("Updated target "),_target_id,RemoteObject.createImmutable(" with value "),_new_value),0);
...
Debug.ShouldStop(16777216);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","01310729",RemoteObject.createImmutable("Invalid input values"),0);
 };
...
public static RemoteObject  _globals() throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Dim PHPURL As String = \"https://192.168.8.141/Com";
...
try {
		Debug.PushSubsStack("home_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,484);
...
try {
		Debug.PushSubsStack("JobDone (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,56);
...
_parser.runVoidMethod ("Initialize",(Object)(_job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ )));
 BA.debugLineNum = 64;BA.debugLine="TableDetails = parser.NextArray";
Debug.ShouldStop(-2147483648);
...
Debug.ShouldStop(16384);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","01179735",RemoteObject.createImmutable("Error loading image"),0);
 };
...
Debug.ShouldStop(262144);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","01179931",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
...
try {
		Debug.PushSubsStack("Label17_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,489);
...
try {
		Debug.PushSubsStack("LoadCompanyData (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,36);
...
try {
		Debug.PushSubsStack("responsiveLabel (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,468);
...
try {
		Debug.PushSubsStack("totalTarget_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,446);
...
try {
		Debug.PushSubsStack("totalTargetTitle_Click (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,454);
...
Debug.ShouldStop(1024);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","01441797",RemoteObject.concat(_target_id,RemoteObject.createImmutable("This is clicked id")),0);
...
try {
		Debug.PushSubsStack("UpdateData_Remote (branch) ","branch",2,branch.mostCurrent.activityBA,branch.mostCurrent,48);
