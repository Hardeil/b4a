...
Debug.ShouldStop(2097152);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","8917510",RemoteObject.concat(RemoteObject.createImmutable("Updated target "),_target_id,RemoteObject.createImmutable(" with value "),_new_value),0);
...
Debug.ShouldStop(16777216);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","8917513",RemoteObject.createImmutable("Invalid input values"),0);
 };
...
Debug.ShouldStop(16384);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","8786519",RemoteObject.createImmutable("Error loading image"),0);
 };
...
Debug.ShouldStop(262144);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","8786715",RemoteObject.concat(RemoteObject.createImmutable("Unknown job: "),_job.getField(true,"_jobname" /*RemoteObject*/ )),0);
 break; }
}
;
...
Debug.ShouldStop(1024);
branch.mostCurrent.__c.runVoidMethod ("LogImpl","81048581",RemoteObject.concat(_target_id,RemoteObject.createImmutable("This is clicked id")),0);
