...
anywheresoftware.b4a.keywords.Common.LogImpl("8917510","Updated target "+BA.NumberToString(_target_id)+" with value "+BA.NumberToString(_new_value),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("8917513","Invalid input values",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("8786519","Error loading image",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("8786715","Unknown job: "+_job._jobname /*String*/ ,0);
 break; }
}
;
 } 
...
anywheresoftware.b4a.keywords.Common.LogImpl("81048581",_target_id+"This is clicked id",0);
