...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Charts",Debug.moduleToString(b4a.example.charts.class),"Dash",Debug.moduleToString(b4a.example.dash.class),"graph",Debug.moduleToString(b4a.example.graph.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Main",Debug.moduleToString(b4a.example.main.class),"Schedule",Debug.moduleToString(b4a.example.schedule.class),"Service",starter.mostCurrent._service};
}
}