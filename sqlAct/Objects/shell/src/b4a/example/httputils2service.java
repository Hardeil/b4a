...
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Charts",Debug.moduleToString(b4a.example.charts.class),"Dash",Debug.moduleToString(b4a.example.dash.class),"graph",Debug.moduleToString(b4a.example.graph.class),"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.example.main.class),"Receiver",httputils2service.mostCurrent._receiver,"Schedule",Debug.moduleToString(b4a.example.schedule.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}