...
try {
		Debug.PushSubsStack("GetFileUri (fileprovider) ","fileprovider",2,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (fileprovider) ","fileprovider",2,__ref.getField(false, "ba"),__ref,39);
